...
<div class="boxed">
	<div class="container">
		 <?php 
		$recent_post = WMHelper::getRecentPosts( 'article' ); 
		?>
		<?php if( $recent_post->have_posts()  ):  ?>
			...
			?>
			<h2 class="section_heading"><?php _e('Latest Article'); ?></h2><br>
		...
		<div class="row">
            <div class="col-md-12 col-lg-7">
				<h2 class="section_heading"><?php _e('Article Library'); ?></h2>
				<div class="tabs-me full-w wm-archive-tabs">
					...
					<div class="tab-content" id="myTabContent">
						<div class="tab-pane fade active show" id="recent" role="tabpanel" aria-labelledby="recent-tab">
							<?php $recent_posts  = WMHelper::getPosts( 'article', array('order' => 'DESC') ); ?>
							...
							<div class="text-center margin-40 wm_loadmore_archive_all">
								<a href="#." class="btn btn-theme-fix btn-gray wm_loadmore_archive_link js_wm_loadmore_archive" data-load-tab="article" data-load-order="DESC"><?php _e('Load More'); ?></a>
							</div>
							<?php endif; ?>  
						</div>
						<div class="tab-pane fade" id="oldest" role="tabpanel" aria-labelledby="oldest-tab">
							<?php $old_posts  = WMHelper::getPosts( 'article', array('order' => 'ASC') ); ?>
							...
							<div class="text-center margin-40 wm_loadmore_archive_all">
								<a href="#." class="btn btn-theme-fix btn-gray wm_loadmore_archive_link js_wm_loadmore_archive" data-load-tab="article" data-load-order="ASC"><?php _e('Load More'); ?></a>
							</div>
							<?php endif; ?>  
						</div>
					</div>
