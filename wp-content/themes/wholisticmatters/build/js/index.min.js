...
"use strict";jQuery(document).ready(function(l){var d=localized_vars.ajaxurl;function c(e){var a=document.createElement("div");return a.appendChild(document.createTextNode(e)),a.innerHTML}function e(){return"ontouchstart"in window||navigator.maxTouchPoints}function c(e){var a=document.createElement("div");return a.appendChild(document.createTextNode(e)),a.innerHTML}Stickyfill.add(l(".hub-sidebar")),Stickyfill.add(l(".primaryHeader")),l(".primaryHeader__utilities-hamburger").on("click",function(e){e.preventDefault(),l(this).toggleClass("open"),l(".primaryHeader__nav").toggleClass("open")}),window.matchMedia("(max-width: 1099px)").matches&&(l("#primaryNav .primaryNav__top-list > li > span").on("click",function(e){e.preventDefault();var a=l(this).hasClass("active");l(".primaryNav__top-list > li > span").removeClass("active"),l(".primaryNav__dropdown").hide(),a||(l(this).addClass("active"),l(this).next(".primaryNav__dropdown").show(),window.scroll(0,0))}),l(".primaryNav__dropdown-column h3").on("click",function(e){e.preventDefault();var a=l(this).hasClass("active");l(".primaryNav__dropdown-column h3").removeClass("active"),l(".primaryNav__dropdown-column ul").hide(),a||(l(this).addClass("active"),l(this).next(".primaryNav__dropdown-column ul").show())}));function t(){l(".primaryHeader__utilities-hamburger, .primaryHeader__nav").removeClass("open")}if(e()&&(l("body").addClass("is-touch-device"),l(".primary-nav .dropdown-menu").on("click.bs.dropdown",function(e){e.stopPropagation()}),l('.primary-nav [data-wm-plugin="collapse"]').trigger("click")),l(document).ready(function(){l(".owl-carousel").owlCarousel({margin:15,nav:!0,dots:!1,loop:!0,responsive:{0:{items:1},600:{items:3},1e3:{items:3}}})}),l(".form-control").focus(function(){l(this).parent().addClass("is-focused")}).blur(function(){""==l(this).val()&&l(this).parent().removeClass("is-focused")}),l(".signupForm").each(function(){l(this).validate({ignore:".ignore",rules:{first_name:"required",last_name:"required",email:"required",password:{required:!0,minlength:8},_wm_hc_professional_type:{required:"#user_role_hcp:checked"},hiddenRecaptcha:{required:function(){return""==grecaptcha.getResponse()}}},messages:{first_name:"Please enter your firstname",last_name:"Please enter your lastname",email:"Please enter your email",password:{required:"Please provide a password",minlength:""}},errorElement:"em",errorPlacement:function(e,a){e.addClass("invalid-feedback"),"checkbox"===a.prop("type")?e.insertAfter(a.next("label")):e.insertAfter(a)},highlight:function(e,a,t){l(e).addClass("is-invalid").removeClass("is-valid")},unhighlight:function(e,a,t){l(e).addClass("is-valid").removeClass("is-invalid")},submitHandler:function(e){e.submit()}})}),l(".LoginForm").each(function(){l(this).validate({rules:{log:"required",pwd:{required:!0}},messages:{log:"Please enter your email",pwd:{required:"Please provide a password"}},errorElement:"em",errorPlacement:function(e,a){e.addClass("invalid-feedback"),"checkbox"===a.prop("type")?e.insertAfter(a.next("label")):e.insertAfter(a)},highlight:function(e,a,t){l(e).addClass("is-invalid").removeClass("is-valid")},unhighlight:function(e,a,t){l(e).addClass("is-valid").removeClass("is-invalid")},submitHandler:function(e){console.log("submit form"),e.submit()}})}),l(".contactForm").each(function(){l(this).validate({rules:{firstName:"required",lastName:"required",email:"required",message:"required",contactName:{required:!0,minlength:6},password:{required:!0,minlength:8},subject:{required:!0,minlength:6}},messages:{firstName:"Please enter your firstname",lastName:"Please enter your lastname",email:"Please enter your email",message:"Please enter your message",contactName:{required:"Please enter your name",minlength:"Please enter minimum 6 characters"},password:{required:"Please provide a password",minlength:"Please use 8 or more characters with a mix of letters, numbers & symbols"},subject:{required:"Please enter subject",minlength:"Please enter minimum 6 characters"}},errorElement:"em",errorPlacement:function(e,a){e.addClass("invalid-feedback"),"checkbox"===a.prop("type")?e.insertAfter(a.next("label")):e.insertAfter(a)},highlight:function(e,a,t){l(e).addClass("is-invalid").removeClass("is-valid")},unhighlight:function(e,a,t){l(e).addClass("is-valid").removeClass("is-invalid")}})}),l("body").on("click",".password-show",function(){var e=l(l(this).attr("data-password-field"));0<e.length&&("password"===e.attr("type")?e.attr("type","text"):e.attr("type","password"))}),l(".closeModal").on("click",function(e){e.preventDefault(),l(".signUpScreenPopup").removeClass("opened"),l(".LoginScreenPopup").removeClass("opened"),l("body").removeClass("no-scroll")}),l("body").on("click",".signup_popup",function(e){e.preventDefault(),t(),l(".LoginScreenPopup").removeClass("opened"),l(".signUpScreenPopup").addClass("opened"),l(".premium-signup-modal").hide(),l("body").addClass("no-scroll")}),l(".login_popup").on("click",function(e){e.preventDefault();var a=function(e,a){a=a||window.location.href,e=e.replace(/[\[\]]/g,"\\$&");var t=new RegExp("[?&]"+e+"(=([^&#]*)|&|#|$)").exec(a);return t?t[2]?decodeURIComponent(t[2].replace(/\+/g," ")):"":null}("redirect_to",l(this).attr("href"));t(),l(".signUpScreenPopup").removeClass("opened"),l(".LoginScreenPopup").addClass("opened"),a&&l(".LoginScreenPopup").find('input[name="redirect_to"]').val(a),l("body").addClass("no-scroll")}),l(".LoginScreenPopup").on("click",function(e){e.preventDefault(),l(e.target).closest(".login-wrapp").length||(l(".LoginScreenPopup").removeClass("opened"),l("body").removeClass("no-scroll"))}),l(".primaryHeader__utilities-search a").on("click",function(){l(".search-overlay").toggle(),l(".search-box").toggle(),l("body").toggleClass("search-open"),l(this).toggleClass("active")}),l(".short_link_search").on("click",function(){l(".advance-search").toggle()}),l(".close-search, .search-overlay").on("click",function(){l(".wm_close_search").click()}),l(document).ready(function(){l("#form-login-account").validate({rules:{email:"required",password:{required:!0,minlength:8}},messages:{email:"Please enter your email",password:{required:"Please provide a password",minlength:"Please use 8 or more characters with a mix of letters, numbers & symbols"}},errorElement:"em",errorPlacement:function(e,a){e.addClass("invalid-feedback"),"checkbox"===a.prop("type")?e.insertAfter(a.next("label")):e.insertAfter(a)},highlight:function(e,a,t){l(e).addClass("is-invalid").removeClass("is-valid")},unhighlight:function(e,a,t){l(e).addClass("is-valid").removeClass("is-invalid")}})}),l(window).scroll(function(){500<=l(window).scrollTop()?l(".floating-icons").addClass("fixed"):l(".floating-icons").removeClass("fixed")}),l(".signUpScreen").on("click",".user_role",function(){var e=l(this),a=e.closest(".signUpScreen"),t=a.find("#finish"),i=a.find("#continue");e.hasClass("hcp")?(t.hide(),i.show()):e.hasClass("non-hcp")&&(i.hide(),t.show())}),l(".signUpScreen .user_role:checked").trigger("click"),l(".signUpScreen").on("click","#continue-next",function(){var e=l(this).closest(".signUpScreen").hasClass("signUpScreenPopup")?"#signupFormPopup":"#signupForm",a=l(e),t=a.validate(),i=!0;l(this).closest(".inner-wrapp").find("input").each(function(){!t.element(this)&&i&&(i=!1)}),i&&(a.find(".Data-one").hide(),a.find("#continue-data").show(),a.find("#continue").hide())}),l(".angle > i").click(function(e){e.preventDefault(),e.stopPropagation(),l(this).closest(".drop").toggleClass("open-child")}),l("body").hasClass("wm_is_premium")&&l("#site-content").find("a[href], area[href], input:not([disabled]), select:not([disabled]), textarea:not([disabled]), button:not([disabled]), iframe, object, embed, *[tabindex], *[contenteditable]").attr("tabindex","-1"),e()||l("ul.nav li.dropdown").hover(function(){l(this).addClass("show"),l(this).children(".dropdown-menu").addClass("show"),l(this).children(".dropdown-toggle").attr("aria-expanded",!0)},function(){l(this).removeClass("show"),l(this).children(".dropdown-menu").removeClass("show"),l(this).children(".dropdown-toggle").attr("aria-expanded",!1)}),l(".articles-secton")&&l(".articles-secton").length){var a=l(".articles-secton").offset().top-l("header.sticky-top").height()-25;l("body").scroll(function(){var e=l("body").scrollTop();a<=e&&l(".article-block").addClass("fixed-aside"),e<a&&l(".article-block").removeClass("fixed-aside")})}var i=l(".newsletter-signup-form");l.each(i,function(e,a){var t,i,s=a,o=l(s).find(".message"),r=Cookies.get("wm-hide-newsletter-modal"),n=l(s).parents(".newsletter-modal");n.length&&(t=n.find(".close"),i=n.find(".no-thanks"),t.on("click",function(e){e.preventDefault(),n.css("display","none"),console.log("close"),void 0===r&&Cookies.set("wm-hide-newsletter-modal",!0,{expires:7})}),i.on("click",function(e){e.preventDefault(),n.css("display","none"),console.log("close"),void 0===r&&Cookies.set("wm-hide-newsletter-modal",!0,{expires:7})})),void 0===r&&setTimeout(function(){n.css("display","flex")},3e3),l(".newsletter-signup-modal-trigger").on("click",function(e){e.preventDefault(),n.css("display","flex")}),l(s).validate({invalidHandler:function(e,a){e.preventDefault(),o.empty()},submitHandler:function(e,a){a.preventDefault();var t={action:"wm_mc_put_contact",security:wm_bookmark.nonce,data:{email_address:null,status_if_new:"subscribed",status:"subscribed",merge_fields:{}}},i=jQuery(a.target).find("input[name=email]"),s=jQuery(a.target).find("input[name=fname]"),n=jQuery(a.target).find("input[name=lname]");void 0!==i.val()&&(t.data.email_address=c(i.val()),t.email=i.val()),void 0!==s.val()&&(t.data.merge_fields.FNAME=c(s.val())),void 0!==n.val()&&(t.data.merge_fields.LNAME=c(n.val())),l.post(d,t,function(e){var a=JSON.parse(JSON.parse(e));o.empty(),400!==a.status?(o.html('<p class="success">You\'ve been subscribed!</p>'),Cookies.set("wm-hide-newsletter-modal",!0,{expires:90}),r=Cookies.get("wm-hide-newsletter-modal")):o.html('<p class="error">This user has previously unsubscribed.</p>')})}})}),l("body").on("click",function(e){0===l(e.target).closest(".premium-info-popup.active").length&&0===l(e.target).closest(".premium-info-btn").length&&l(".premium-info-popup").removeClass("active")}),l("body").on("click",".premium-info-btn",function(e){e.preventDefault(),window.matchMedia("(max-width: 768px)").matches?l(".premium-signup-modal").css("display","flex"):(l(".premium-info-popup").removeClass("active"),l(this).next(".premium-info-popup").addClass("active"))}),l(".premium-signup-modal .close").on("click",function(e){e.preventDefault(),l(".premium-signup-modal").hide()}),l('.wm-archive-tabs .nav-link[data-toggle="tab"]').on("click",function(e){var a=l(this).attr("aria-controls");l(".image-text-module[data-accordion-parent]").addClass("d-none"),l('.image-text-module[data-accordion-parent="'+a+'"]').removeClass("d-none"),l(".articles-secton .article-block[data-accordion-parent]").addClass("d-none"),l('.articles-secton .article-block[data-accordion-parent="'+a+'"]').removeClass("d-none"),l(".course-additional-copy[data-accordion-parent]").hide(),l('.course-additional-copy[data-accordion-parent="'+a+'"]').show()});l(".hub-sidebar");var s=l("#primaryHeader").outerHeight(),n=(l(".modules-container"),l(".sidebar-header")),o=l(".sidebar-mobile-collapse");l(".sidebar-list a").on("click",function(e){e.preventDefault();var a=l(l(this).attr("href")),t=a.offset().top-(s+20);window.matchMedia("(max-width: 991px)").matches&&(o.slideUp(0),n.removeClass("active"),t=a.offset().top-(s+n.outerHeight()+20)),l("html, body").animate({scrollTop:t},100,"linear")}),window.matchMedia("(max-width: 991px)").matches&&n.on("click",function(e){e.preventDefault(),o.stop().slideToggle(),n.stop().toggleClass("active")});var r=l(".bl-page"),m=l(".bl-ipad").height(),u=l(".banner-inner"),p=l(".bl-icon-cols");if(r&&(l(u).css({"padding-bottom":m/2}),l(p).css({"margin-top":m/2*-1}),l(window).on("resize",function(){var e=l(".bl-ipad").height();l(u).css({"padding-bottom":e/2}),l(p).css({"margin-top":e/2*-1})})),document.getElementById("systems-scroller")){var h=function(){y||requestAnimationFrame(v),y=!0},v=function(e){y=!1;window.scrollY;f=window.scrollY;var a=g-(b+f),t=g-(f-w);if(a<=0&&0<=t){var i=t-a,s=22-44*Math.abs(a/i);C.style.transform="translateX("+s+"vw)"}},f=0,g=document.getElementById("systems-scroller").offsetTop,w=document.getElementById("systems-scroller").offsetHeight,b=window.innerHeight,C=(window.innerWidth,document.getElementById("scroller-inner")),y=!1;window.addEventListener("scroll",function(e){h()},!1)}var k=l(window).height()-l(".interactive-header").outerHeight();if(l(".interactive-body iframe").css("height",k),l(".biodigital-content-body").hasClass("gated-content"))for(var _=l(".model-btn"),x=0;x<=_.length;x++)0!==x&&l(_[x]).addClass("gated");l("body").on("click","#create-new-account-btn",function(e){e.preventDefault(),t(),l(".LoginScreenPopup").removeClass("opened"),l(".signUpScreenPopup").addClass("opened"),l(".premium-signup-modal").hide(),l("body").addClass("no-scroll")}),l(".drawer-toggle").on("click",function(e){l(".interactive-drawer").hasClass("active")?l(".interactive-drawer").removeClass("active"):l(".interactive-drawer").addClass("active"),l(".content-container").toggleClass("active")}),l(".model-btn").on("click",function(e){var a=l(e.target).closest('div[class^="model-btn"]');if(l(a).hasClass("gated"))e.preventDefault();else{l(".model-btn").removeClass("active"),l(a).addClass("active");var t=l(a).data("src");l("iframe").attr("src",t);var i=l(a).find(".label"),s=l(i).text();l(".viewing-model").text(s);var n=l(".headerviewing-text").outerHeight()+60,o="calc(100vh - "+n+"px)";l(".interactive-drawer").css({height:o,top:n+"px"})}}),l(".system-block").on("click",function(e){var a=l(".system-block"),t=l(e.target).closest('div[class^="system-block"]'),r=l(t).data("value");l(t).hasClass("active")||(l(a).removeClass("active"),l(t).addClass("active"),l(".models-inner").removeClass("active"),l(".models-inner").each(function(){var e=l(this).data("system");if(e==r){l(this).addClass("active");var a=l(this).find(".model-btn");if(!l(a[0]).hasClass("gated")){l(a).removeClass("active"),l(a[0]).addClass("active");var t=l(a[0]).data("src");l("iframe").attr("src",t),l(".viewing-system").text(e+" System");var i=l(a[0]).find(".label"),s=l(i).text();l(".viewing-model").text(s);var n=l(".headerviewing-text").outerHeight()+60,o="calc(100vh - "+n+"px)";l(".interactive-drawer").css({height:o,top:n+"px"})}}}))})});