...
"use strict";function _classCallCheck(t,e){if(!(t instanceof e))throw new TypeError("Cannot call a class as a function")}function _defineProperties(t,e){for(var i=0;i<e.length;i++){var o=e[i];o.enumerable=o.enumerable||!1,o.configurable=!0,"value"in o&&(o.writable=!0),Object.defineProperty(t,o.key,o)}}function _createClass(t,e,i){return e&&_defineProperties(t.prototype,e),i&&_defineProperties(t,i),t}var seppuku=!1,isWindowDefined="undefined"!=typeof window;if(isWindowDefined&&window.getComputedStyle){var testNode=document.createElement("div");["","-webkit-","-moz-","-ms-"].some(function(t){try{testNode.style.position=t+"sticky"}catch(t){}return""!=testNode.style.position})&&(seppuku=!0)}else seppuku=!0;var isInitialized=!1,shadowRootExists="undefined"!=typeof ShadowRoot,scroll={top:null,left:null},stickies=[];function extend(t,e){for(var i in e)e.hasOwnProperty(i)&&(t[i]=e[i])}function parseNumeric(t){return parseFloat(t)||0}function getDocOffsetTop(t){for(var e=0;t;)e+=t.offsetTop,t=t.offsetParent;return e}var Sticky=function(){function t(e){if(_classCallCheck(this,t),!(e instanceof HTMLElement))throw new Error("First argument must be HTMLElement");if(stickies.some(function(t){return t._node===e}))throw new Error("Stickyfill is already applied to this node");this._node=e,this._stickyMode=null,this._active=!1,stickies.push(this),this.refresh()}return _createClass(t,[{key:"refresh",value:function(){if(!seppuku&&!this._removed){this._active&&this._deactivate();var t=this._node,e=getComputedStyle(t),i={position:e.position,top:e.top,display:e.display,marginTop:e.marginTop,marginBottom:e.marginBottom,marginLeft:e.marginLeft,marginRight:e.marginRight,cssFloat:e.cssFloat};if(!isNaN(parseFloat(i.top))&&"table-cell"!=i.display&&"none"!=i.display){this._active=!0;var o=t.style.position;"sticky"!=e.position&&"-webkit-sticky"!=e.position||(t.style.position="static");var n=t.parentNode,s=shadowRootExists&&n instanceof ShadowRoot?n.host:n,r=t.getBoundingClientRect(),a=s.getBoundingClientRect(),f=getComputedStyle(s);this._parent={node:s,styles:{position:s.style.position},offsetHeight:s.offsetHeight},this._offsetToWindow={left:r.left,right:document.documentElement.clientWidth-r.right},this._offsetToParent={top:r.top-a.top-parseNumeric(f.borderTopWidth),left:r.left-a.left-parseNumeric(f.borderLeftWidth),right:-r.right+a.right-parseNumeric(f.borderRightWidth)},this._styles={position:o,top:t.style.top,bottom:t.style.bottom,left:t.style.left,right:t.style.right,width:t.style.width,marginTop:t.style.marginTop,marginLeft:t.style.marginLeft,marginRight:t.style.marginRight};var l=parseNumeric(i.top);this._limits={start:r.top+window.pageYOffset-l,end:a.top+window.pageYOffset+s.offsetHeight-parseNumeric(f.borderBottomWidth)-t.offsetHeight-l-parseNumeric(i.marginBottom)};var c=f.position;"absolute"!=c&&"relative"!=c&&(s.style.position="relative"),this._recalcPosition();var d=this._clone={};d.node=document.createElement("div"),extend(d.node.style,{width:r.right-r.left+"px",height:r.bottom-r.top+"px",marginTop:i.marginTop,marginBottom:i.marginBottom,marginLeft:i.marginLeft,marginRight:i.marginRight,cssFloat:i.cssFloat,padding:0,border:0,borderSpacing:0,fontSize:"1em",position:"static"}),n.insertBefore(d.node,t),d.docOffsetTop=getDocOffsetTop(d.node)}}}},{key:"_recalcPosition",value:function(){if(this._active&&!this._removed){var t=scroll.top<=this._limits.start?"start":scroll.top>=this._limits.end?"end":"middle";if(this._stickyMode!=t){switch(t){case"start":extend(this._node.style,{position:"absolute",left:this._offsetToParent.left+"px",right:this._offsetToParent.right+"px",top:this._offsetToParent.top+"px",bottom:"auto",width:"auto",marginLeft:0,marginRight:0,marginTop:0});break;case"middle":extend(this._node.style,{position:"fixed",left:this._offsetToWindow.left+"px",right:this._offsetToWindow.right+"px",top:this._styles.top,bottom:"auto",width:"auto",marginLeft:0,marginRight:0,marginTop:0});break;case"end":extend(this._node.style,{position:"absolute",left:this._offsetToParent.left+"px",right:this._offsetToParent.right+"px",top:"auto",bottom:0,width:"auto",marginLeft:0,marginRight:0})}this._stickyMode=t}}}},{key:"_fastCheck",value:function(){this._active&&!this._removed&&(1<Math.abs(getDocOffsetTop(this._clone.node)-this._clone.docOffsetTop)||1<Math.abs(this._parent.node.offsetHeight-this._parent.offsetHeight))&&this.refresh()}},{key:"_deactivate",value:function(){var e=this;this._active&&!this._removed&&(this._clone.node.parentNode.removeChild(this._clone.node),delete this._clone,extend(this._node.style,this._styles),delete this._styles,stickies.some(function(t){return t!==e&&t._parent&&t._parent.node===e._parent.node})||extend(this._parent.node.style,this._parent.styles),delete this._parent,this._stickyMode=null,this._active=!1,delete this._offsetToWindow,delete this._offsetToParent,delete this._limits)}},{key:"remove",value:function(){var i=this;this._deactivate(),stickies.some(function(t,e){if(t._node===i._node)return stickies.splice(e,1),!0}),this._removed=!0}}]),t}(),Stickyfill={stickies:stickies,Sticky:Sticky,forceSticky:function(){seppuku=!1,init(),this.refreshAll()},addOne:function(t){if(!(t instanceof HTMLElement)){if(!t.length||!t[0])return;t=t[0]}for(var e=0;e<stickies.length;e++)if(stickies[e]._node===t)return stickies[e];return new Sticky(t)},add:function(i){if(i instanceof HTMLElement&&(i=[i]),i.length){for(var o=[],t=function(t){var e=i[t];return e instanceof HTMLElement?stickies.some(function(t){if(t._node===e)return o.push(t),!0})?"continue":void o.push(new Sticky(e)):(o.push(void 0),"continue")},e=0;e<i.length;e++)t(e);return o}},refreshAll:function(){stickies.forEach(function(t){return t.refresh()})},removeOne:function(e){if(!(e instanceof HTMLElement)){if(!e.length||!e[0])return;e=e[0]}stickies.some(function(t){if(t._node===e)return t.remove(),!0})},remove:function(i){if(i instanceof HTMLElement&&(i=[i]),i.length)for(var t=function(t){var e=i[t];stickies.some(function(t){if(t._node===e)return t.remove(),!0})},e=0;e<i.length;e++)t(e)},removeAll:function(){for(;stickies.length;)stickies[0].remove()}};function init(){var t,e,i;isInitialized||(isInitialized=!0,o(),window.addEventListener("scroll",o),window.addEventListener("resize",Stickyfill.refreshAll),window.addEventListener("orientationchange",Stickyfill.refreshAll),"hidden"in document?(e="hidden",i="visibilitychange"):"webkitHidden"in document&&(e="webkitHidden",i="webkitvisibilitychange"),i?(document[e]||n(),document.addEventListener(i,function(){document[e]?clearInterval(t):n()})):n());function o(){window.pageXOffset!=scroll.left?(scroll.top=window.pageYOffset,scroll.left=window.pageXOffset,Stickyfill.refreshAll()):window.pageYOffset!=scroll.top&&(scroll.top=window.pageYOffset,scroll.left=window.pageXOffset,stickies.forEach(function(t){return t._recalcPosition()}))}function n(){t=setInterval(function(){stickies.forEach(function(t){return t._fastCheck()})},500)}}seppuku||init(),"undefined"!=typeof module&&module.exports?module.exports=Stickyfill:isWindowDefined&&(window.Stickyfill=Stickyfill);
...
"use strict";function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function _defineProperties(e,t){for(var i=0;i<t.length;i++){var s=t[i];s.enumerable=s.enumerable||!1,s.configurable=!0,"value"in s&&(s.writable=!0),Object.defineProperty(e,s.key,s)}}function _createClass(e,t,i){return t&&_defineProperties(e.prototype,t),i&&_defineProperties(e,i),e}jQuery(document).ready(function(l){var c=localized_vars.ajaxurl;function d(e){var t=document.createElement("div");return t.appendChild(document.createTextNode(e)),t.innerHTML}function e(){return"ontouchstart"in window||navigator.maxTouchPoints}function d(e){var t=document.createElement("div");return t.appendChild(document.createTextNode(e)),t.innerHTML}Stickyfill.add(l(".hub-sidebar")),Stickyfill.add(l(".primaryHeader")),l(".primaryHeader__utilities-hamburger").on("click",function(e){e.preventDefault(),l(this).toggleClass("open"),l(".primaryHeader__nav").toggleClass("open")}),window.matchMedia("(max-width: 1099px)").matches&&(l("#primaryNav .primaryNav__top-list > li > span").on("click",function(e){e.preventDefault();var t=l(this).hasClass("active");l(".primaryNav__top-list > li > span").removeClass("active"),l(".primaryNav__dropdown").hide(),t||(l(this).addClass("active"),l(this).next(".primaryNav__dropdown").show(),window.scroll(0,0))}),l(".primaryNav__dropdown-column h3").on("click",function(e){e.preventDefault();var t=l(this).hasClass("active");l(".primaryNav__dropdown-column h3").removeClass("active"),l(".primaryNav__dropdown-column ul").hide(),t||(l(this).addClass("active"),l(this).next(".primaryNav__dropdown-column ul").show())}));function i(){l(".primaryHeader__utilities-hamburger, .primaryHeader__nav").removeClass("open")}if(e()&&(l("body").addClass("is-touch-device"),l(".primary-nav .dropdown-menu").on("click.bs.dropdown",function(e){e.stopPropagation()}),l('.primary-nav [data-wm-plugin="collapse"]').trigger("click")),l(document).ready(function(){l(".owl-carousel").owlCarousel({margin:15,nav:!0,dots:!1,loop:!0,responsive:{0:{items:1},600:{items:3},1e3:{items:3}}})}),l(".form-control").focus(function(){l(this).parent().addClass("is-focused")}).blur(function(){""==l(this).val()&&l(this).parent().removeClass("is-focused")}),l(".signupForm").each(function(){l(this).validate({ignore:".ignore",rules:{first_name:"required",last_name:"required",email:"required",password:{required:!0,minlength:8},_wm_hc_professional_type:{required:"#user_role_hcp:checked"},hiddenRecaptcha:{required:function(){return""==grecaptcha.getResponse()}}},messages:{first_name:"Please enter your firstname",last_name:"Please enter your lastname",email:"Please enter your email",password:{required:"Please provide a password",minlength:""}},errorElement:"em",errorPlacement:function(e,t){e.addClass("invalid-feedback"),"checkbox"===t.prop("type")?e.insertAfter(t.next("label")):e.insertAfter(t)},highlight:function(e,t,i){l(e).addClass("is-invalid").removeClass("is-valid")},unhighlight:function(e,t,i){l(e).addClass("is-valid").removeClass("is-invalid")},submitHandler:function(e){e.submit()}})}),l(".LoginForm").each(function(){l(this).validate({rules:{log:"required",pwd:{required:!0}},messages:{log:"Please enter your email",pwd:{required:"Please provide a password"}},errorElement:"em",errorPlacement:function(e,t){e.addClass("invalid-feedback"),"checkbox"===t.prop("type")?e.insertAfter(t.next("label")):e.insertAfter(t)},highlight:function(e,t,i){l(e).addClass("is-invalid").removeClass("is-valid")},unhighlight:function(e,t,i){l(e).addClass("is-valid").removeClass("is-invalid")},submitHandler:function(e){console.log("submit form"),e.submit()}})}),l(".contactForm").each(function(){l(this).validate({rules:{firstName:"required",lastName:"required",email:"required",message:"required",contactName:{required:!0,minlength:6},password:{required:!0,minlength:8},subject:{required:!0,minlength:6}},messages:{firstName:"Please enter your firstname",lastName:"Please enter your lastname",email:"Please enter your email",message:"Please enter your message",contactName:{required:"Please enter your name",minlength:"Please enter minimum 6 characters"},password:{required:"Please provide a password",minlength:"Please use 8 or more characters with a mix of letters, numbers & symbols"},subject:{required:"Please enter subject",minlength:"Please enter minimum 6 characters"}},errorElement:"em",errorPlacement:function(e,t){e.addClass("invalid-feedback"),"checkbox"===t.prop("type")?e.insertAfter(t.next("label")):e.insertAfter(t)},highlight:function(e,t,i){l(e).addClass("is-invalid").removeClass("is-valid")},unhighlight:function(e,t,i){l(e).addClass("is-valid").removeClass("is-invalid")}})}),l("body").on("click",".password-show",function(){var e=l(l(this).attr("data-password-field"));0<e.length&&("password"===e.attr("type")?e.attr("type","text"):e.attr("type","password"))}),l(".closeModal").on("click",function(e){e.preventDefault(),l(".signUpScreenPopup").removeClass("opened"),l(".LoginScreenPopup").removeClass("opened"),l("body").removeClass("no-scroll")}),l("body").on("click",".signup_popup",function(e){e.preventDefault(),i(),l(".LoginScreenPopup").removeClass("opened"),l(".signUpScreenPopup").addClass("opened"),l(".premium-signup-modal").hide(),l("body").addClass("no-scroll")}),l(".login_popup").on("click",function(e){e.preventDefault();var t=function(e,t){t=t||window.location.href,e=e.replace(/[\[\]]/g,"\\$&");var i=new RegExp("[?&]"+e+"(=([^&#]*)|&|#|$)").exec(t);return i?i[2]?decodeURIComponent(i[2].replace(/\+/g," ")):"":null}("redirect_to",l(this).attr("href"));i(),l(".signUpScreenPopup").removeClass("opened"),l(".LoginScreenPopup").addClass("opened"),t&&l(".LoginScreenPopup").find('input[name="redirect_to"]').val(t),l("body").addClass("no-scroll")}),l(".LoginScreenPopup").on("click",function(e){e.preventDefault(),l(e.target).closest(".login-wrapp").length||(l(".LoginScreenPopup").removeClass("opened"),l("body").removeClass("no-scroll"))}),l(".primaryHeader__utilities-search a").on("click",function(){l(".search-overlay").toggle(),l(".search-box").toggle(),l("body").toggleClass("search-open"),l(this).toggleClass("active")}),l(".short_link_search").on("click",function(){l(".advance-search").toggle()}),l(".close-search, .search-overlay").on("click",function(){l(".wm_close_search").click()}),l(document).ready(function(){l("#form-login-account").validate({rules:{email:"required",password:{required:!0,minlength:8}},messages:{email:"Please enter your email",password:{required:"Please provide a password",minlength:"Please use 8 or more characters with a mix of letters, numbers & symbols"}},errorElement:"em",errorPlacement:function(e,t){e.addClass("invalid-feedback"),"checkbox"===t.prop("type")?e.insertAfter(t.next("label")):e.insertAfter(t)},highlight:function(e,t,i){l(e).addClass("is-invalid").removeClass("is-valid")},unhighlight:function(e,t,i){l(e).addClass("is-valid").removeClass("is-invalid")}})}),l(window).scroll(function(){500<=l(window).scrollTop()?l(".floating-icons").addClass("fixed"):l(".floating-icons").removeClass("fixed")}),l(".signUpScreen").on("click",".user_role",function(){var e=l(this),t=e.closest(".signUpScreen"),i=t.find("#finish"),s=t.find("#continue");e.hasClass("hcp")?(i.hide(),s.show()):e.hasClass("non-hcp")&&(s.hide(),i.show())}),l(".signUpScreen .user_role:checked").trigger("click"),l(".signUpScreen").on("click","#continue-next",function(){var e=l(this).closest(".signUpScreen").hasClass("signUpScreenPopup")?"#signupFormPopup":"#signupForm",t=l(e),i=t.validate(),s=!0;l(this).closest(".inner-wrapp").find("input").each(function(){!i.element(this)&&s&&(s=!1)}),s&&(t.find(".Data-one").hide(),t.find("#continue-data").show(),t.find("#continue").hide())}),l(".angle > i").click(function(e){e.preventDefault(),e.stopPropagation(),l(this).closest(".drop").toggleClass("open-child")}),l("body").hasClass("wm_is_premium")&&l("#site-content").find("a[href], area[href], input:not([disabled]), select:not([disabled]), textarea:not([disabled]), button:not([disabled]), iframe, object, embed, *[tabindex], *[contenteditable]").attr("tabindex","-1"),e()||l("ul.nav li.dropdown").hover(function(){l(this).addClass("show"),l(this).children(".dropdown-menu").addClass("show"),l(this).children(".dropdown-toggle").attr("aria-expanded",!0)},function(){l(this).removeClass("show"),l(this).children(".dropdown-menu").removeClass("show"),l(this).children(".dropdown-toggle").attr("aria-expanded",!1)}),l(".articles-secton")&&l(".articles-secton").length){var t=l(".articles-secton").offset().top-l("header.sticky-top").height()-25;l("body").scroll(function(){var e=l("body").scrollTop();t<=e&&l(".article-block").addClass("fixed-aside"),e<t&&l(".article-block").removeClass("fixed-aside")})}var s=l(".newsletter-signup-form");l.each(s,function(e,t){var i,s,a=t,r=l(a).find(".message"),o=Cookies.get("wm-hide-newsletter-modal"),n=l(a).parents(".newsletter-modal");n.length&&(i=n.find(".close"),s=n.find(".no-thanks"),i.on("click",function(e){e.preventDefault(),n.css("display","none"),console.log("close"),void 0===o&&Cookies.set("wm-hide-newsletter-modal",!0,{expires:7})}),s.on("click",function(e){e.preventDefault(),n.css("display","none"),console.log("close"),void 0===o&&Cookies.set("wm-hide-newsletter-modal",!0,{expires:7})})),void 0===o&&setTimeout(function(){n.css("display","flex")},3e3),l(".newsletter-signup-modal-trigger").on("click",function(e){e.preventDefault(),n.css("display","flex")}),l(a).validate({invalidHandler:function(e,t){e.preventDefault(),r.empty()},submitHandler:function(e,t){t.preventDefault();var i={action:"wm_mc_put_contact",security:wm_bookmark.nonce,data:{email_address:null,status_if_new:"subscribed",status:"subscribed",merge_fields:{}}},s=jQuery(t.target).find("input[name=email]"),a=jQuery(t.target).find("input[name=fname]"),n=jQuery(t.target).find("input[name=lname]");void 0!==s.val()&&(i.data.email_address=d(s.val()),i.email=s.val()),void 0!==a.val()&&(i.data.merge_fields.FNAME=d(a.val())),void 0!==n.val()&&(i.data.merge_fields.LNAME=d(n.val())),l.post(c,i,function(e){var t=JSON.parse(JSON.parse(e));r.empty(),400!==t.status?(r.html('<p class="success">You\'ve been subscribed!</p>'),Cookies.set("wm-hide-newsletter-modal",!0,{expires:90}),o=Cookies.get("wm-hide-newsletter-modal")):r.html('<p class="error">This user has previously unsubscribed.</p>')})}})}),l("body").on("click",function(e){0===l(e.target).closest(".premium-info-popup.active").length&&0===l(e.target).closest(".premium-info-btn").length&&l(".premium-info-popup").removeClass("active")}),l("body").on("click",".premium-info-btn",function(e){e.preventDefault(),window.matchMedia("(max-width: 768px)").matches?l(".premium-signup-modal").css("display","flex"):(l(".premium-info-popup").removeClass("active"),l(this).next(".premium-info-popup").addClass("active"))}),l(".premium-signup-modal .close").on("click",function(e){e.preventDefault(),l(".premium-signup-modal").hide()}),l('.wm-archive-tabs .nav-link[data-toggle="tab"]').on("click",function(e){var t=l(this).attr("aria-controls");l(".image-text-module[data-accordion-parent]").addClass("d-none"),l('.image-text-module[data-accordion-parent="'+t+'"]').removeClass("d-none"),l(".articles-secton .article-block[data-accordion-parent]").addClass("d-none"),l('.articles-secton .article-block[data-accordion-parent="'+t+'"]').removeClass("d-none"),l(".course-additional-copy[data-accordion-parent]").hide(),l('.course-additional-copy[data-accordion-parent="'+t+'"]').show()});l(".hub-sidebar");var a=l("#primaryHeader").outerHeight(),n=(l(".modules-container"),l(".sidebar-header")),r=l(".sidebar-mobile-collapse");l(".sidebar-list a").on("click",function(e){e.preventDefault();var t=l(l(this).attr("href")),i=t.offset().top-(a+20);window.matchMedia("(max-width: 991px)").matches&&(r.slideUp(0),n.removeClass("active"),i=t.offset().top-(a+n.outerHeight()+20)),l("html, body").animate({scrollTop:i},100,"linear")}),window.matchMedia("(max-width: 991px)").matches&&n.on("click",function(e){e.preventDefault(),r.stop().slideToggle(),n.stop().toggleClass("active")});var o=l(window).height(),u=l(".interactive-header").outerHeight(),p=l(".headerviewing-text").outerHeight(),m=o-(u+p);l(".interactive-body iframe").css("height",m),l(".interactive-header").css("margin-bottom",p),l(".drawer-toggle").on("click",function(e){l(".interactive-drawer").hasClass("active")||l(".interactive-drawer").addClass("active")}),l(".interactive-drawer__close").on("click",function(){l(".interactive-drawer").removeClass("active")}),l("#extras-acc").on("click",function(){l(".extras-accordion-inner").slideToggle(),l(".extras-arrow").toggleClass("active")}),l("#system-select").on("change",function(){var a=this.value;l(".models-inner").removeClass("active"),l(".models-inner").each(function(){var e=l(this).data("system");if(e==a){l(this).addClass("active");var t=l(this).find(".model-btn");l(t[0]).addClass("active");var i=l(t[0]).data("src");l("iframe").attr("src",i),l(".viewing-system").text(e+" System");var s=l(t[0]).text();l(".viewing-model").text(s)}})}),l(".model-btn").on("click",function(e){l(".model-btn").removeClass("active"),l(e.target).addClass("active");var t=l(e.target).data("src");l("iframe").attr("src",t);var i=l(e.target).text();l(".viewing-model").text(i)});var h=function(){function i(e){_classCallCheck(this,i),this.select=l(e),this.numberOfOptions=this.select.children("option").length,this.selected=this.select.children("option:selected"),this.field=this.select.parents(".field"),this.selected.text()==this.select.children("option").first().text()&&(this.selected=""),this.select.addClass("select-hidden"),this.select.wrap('<div class="select"></div>'),this.select.after('<div class="select-styled"></div>'),this.styledSelect=this.select.next("div.select-styled"),this.styledSelect.text(this.select.children("option").eq(0).text()),this.list=l("<ul />",{class:"select-options"}).insertAfter(this.styledSelect);this.select.children("option").eq(0).val();for(var t=0;t<this.numberOfOptions;t++)l("<li />",{text:this.select.children("option").eq(t).text(),rel:this.select.children("option").eq(t).val()}).appendTo(this.list);this.listItems=this.list.children("li"),""!==this.selected&&(this.styledSelect.text(this.selected.text()),this.select.val(this.selected.text())),this.styledSelect.click(function(e){this.open(e)}.bind(this)),this.styledSelect.parents(".select").focus(function(e){this.open(e)}.bind(this)),this.styledSelect.parents(".select").blur(function(e){this.close(e)}.bind(this)),this.listItems.click(function(e){this.selectOption(e)}.bind(this)),l(document).click(function(){this.close()}.bind(this))}return _createClass(i,[{key:"open",value:function(e){e.stopPropagation(),l("div.select-styled.active").not(this).each(function(){l(this).removeClass("active").next("ul.select-options").hide()}),this.styledSelect.toggleClass("active"),this.list.toggle()}},{key:"close",value:function(){this.styledSelect.removeClass("active"),this.list.hide()}},{key:"selectOption",value:function(e,t){var i;i=l(e.target).attr("rel");this.select.attr("id");e.stopPropagation(),this.styledSelect.text(l(e.target).text()).removeClass("active"),this.select.val(i),this.list.hide();var a=this.select.val();l(".models-inner").removeClass("active"),l(".models-inner").each(function(){var e=l(this).data("system");if(console.log(e,a),e==a){l(this).addClass("active");var t=l(this).find(".model-btn");l(t[0]).addClass("active");var i=l(t[0]).data("src");l("iframe").attr("src",i),l(".viewing-system").text(e+" System");var s=l(t[0]).text();l(".viewing-model").text(s)}})}}]),i}(),v=l("select");if(v.length)for(var f=[],g=0;g<v.length;g++)f[g]=new h(v[g]);l(".primaryHeader__notice .close").on("click",function(e){e.preventDefault(),l("body").removeClass("promobar-enabled"),Cookies.set("wm-hide-promobar",!0),l(this).parents(".primaryHeader__notice").slideUp()})});